...
app.use('/api/auth', auth); app.use('/api/bootstrap', bootstrap); app.use('/api/customer', customer); app.use('/api', api); app.use('/api/admin', admin); app.use('/api/shopkeeper', shopkeeper); app.use('/api/delivery', delivery); app.use('/api/ops', ops);
